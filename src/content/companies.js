...
export const companies = [
  {
    ...
    sector: 'Mining',
    role: 'Mineral exploration, acquisition and extraction in the SADC/SA region.',
  ...
  },
  {
    ...
    name: 'Nyezi Steel',
    sector: 'Industrial',
    role: 'Manufacturing and distribution of steel products for the group’s construction and infrastructure work.',
    body: 'Nyezi Steel specialises in the manufacturing and distribution of high-quality steel products, serving various industries including construction and infrastructure development.',
  ...
  },
  {
    ...
    body: 'AET Group is a renewable energy developer. We are dedicated to harnessing the boundless potential of nature to power a brighter, cleaner future.',
    image: 'AET1.jpg',
  ...
  },
  {
    ...
    sector: 'Property',
    role: 'Property development and construction.',
  ...
  },
  {
    ...
    name: 'DVP Hub',
    sector: 'Technology',
    role: 'ICT infrastructure management.',
    body: 'DVP Hub is a South African and African ICT infrastructure management specialist, ensuring optimal performance and security of IT systems through design, monitoring, security services, cloud solutions, and consulting.',
    image: 'dvp1.jpg',
    ...
    subProducts: [
      {
        name: 'CyberStack',
        mark: '©',
        body: 'CyberStack is DVP’s proprietary ICT and cybersecurity solution, built around one principle: business continuity. When a cyberattack hits, CyberStack keeps your business connected and operational. This means your team keeps working, uninterrupted, while the threat is contained and neutralised.',
      },
      {
        name: 'RailHub',
        mark: '©',
        body: 'Developed in-house, RailHub is a purpose-built solution for the freight rail industry. It brings asset depreciation, real-time fleet feedback, and fleet control together on a single interface, turning operational data into actionable value.',
      },
    ],
  },
]
